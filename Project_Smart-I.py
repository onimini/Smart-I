...
class First(object):   
    def __init__(score):
        ...
        score.label = Label(score.root, text="Insert your scores.", font='Cordia_New 12 bold', fg='blue', bg='#F4A460').place(relx=0.3, rely=0.2, anchor=CENTER)
        ...
        score.eng = Label(score.root, text="English:", font='Cordia_New 10', bg='#F4A460').place(relx=0.3, rely=0.4, anchor=CENTER)
        score.txteng = IntVar()
        Entry(score.root, textvariable=score.txteng, cursor='cross').place(relx=0.7, rely=0.4, anchor=CENTER)

        score.read = Label(score.root, text="Reading:", font='Cordia_New 10', bg='#F4A460').place(relx=0.3, rely=0.5, anchor=CENTER)
        score.txtread = IntVar()
        Entry(score.root, textvariable=score.txtread, cursor='cross').place(relx=0.7, rely=0.5, anchor=CENTER)
        
        score.knowledge = Label(score.root, text="Knowledge:", font='Cordia_New 10', bg='#F4A460').place(relx=0.3, rely=0.6, anchor=CENTER)
